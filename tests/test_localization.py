...
class LocalizationTests(unittest.TestCase):
    ...
    def test_all_languages_have_same_runtime_keys(self) -> None:
        expected_keys = {
            ...
            "UPLOAD_PROMPT",
            "THROTTLED_RETRY_SHORT",
            "UPLOAD_TOO_FREQUENT",
            "UPLOAD_FILE_TYPE_UNSUPPORTED",
            "UPLOAD_FILE_TOO_LARGE",
            "BUTTON_HOW_TO_USE",
            "BUTTON_UPLOAD_TASKS",
            "BUTTON_BUY_POSTS_STARS",
            "BUTTON_BUY_POSTS_CARD",
            "BUTTON_PUBLISH",
            "BUTTON_DOWNLOAD_ARCHIVE",
            "PAYMENT_STARS_SELECT_PACKAGE",
            "PAYMENT_CARD_SELECT_PACKAGE",
            "PAYMENT_STARS_PACKAGE_LABEL",
            "PAYMENT_CARD_PACKAGE_LABEL",
            "PAYMENT_STARS_PACKAGE_SELECTED_STUB",
            "PAYMENT_CARD_PACKAGE_SELECTED_STUB",
            "PAYMENT_CARD_CHECKOUT_URL",
            "PAYMENT_CARD_CHECKOUT_FAILED",
            "PAYMENT_CARD_CHECKOUT_UNAVAILABLE",
            "PAYMENT_STARS_INVOICE_TITLE",
            "PAYMENT_STARS_INVOICE_DESCRIPTION",
            "PAYMENT_STARS_INVOICE_FAILED",
            "PAYMENT_STARS_SUCCESS",
            "PAYMENT_STARS_DUPLICATE",
            "PAYMENT_STARS_INVALID_UPDATE",
            "PAYMENT_STARS_APPLY_FAILED",
            "APPROVAL_READY",
            "APPROVAL_QUEUE_COUNT",
            "APPROVAL_CHOOSE_ACTION",
            "APPROVAL_ALL_PROCESSED",
